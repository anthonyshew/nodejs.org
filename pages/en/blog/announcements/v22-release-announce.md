...
This release improves the performance of `AbortSignal` instances creation by 75% for regular use and 2000% for other cases.
This overall boosts the performance of the Test Runner by 10%-15%.
